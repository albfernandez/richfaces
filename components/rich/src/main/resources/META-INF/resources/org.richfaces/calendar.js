	...
	var CalendarView = {
		...
		getTimeControl: function(calendar) {
			...
			var markup = calendar.options.disabled || calendar.options.readonly ?
				...
				new E('div', {
					'class': 'rf-cal-tl-btn rf-cal-tl-btn-hov rf-cal-btn-press', 'onclick': onclick,
						...
						[
							new E('tr', {},
								[
									...
									new E('td', {
										'class': 'rf-cal-tl rf-cal-btn-close', 'style': function(context) {
					...
					new E('tbody', {},
						[
							new E('tr', {},
								[
									new E('td', {
										'class': 'rf-cal-tl-ftr', 'style': function(context) {
											return (this.isEmpty ? 'display:none;' : '');
										}
									},
										[
