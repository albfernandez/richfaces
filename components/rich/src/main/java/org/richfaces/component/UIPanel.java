...
public class UIPanel extends AbstractPanel
        implements ClientBehaviorHolder, CoreProps, EventsKeyProps, EventsMouseProps {
    ...
    public UIPanel() {
        super();
        setRendererType("org.richfaces.PanelRenderer");
    }
