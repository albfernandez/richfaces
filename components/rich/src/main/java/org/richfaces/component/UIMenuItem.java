...
public class UIMenuItem extends AbstractMenuItem
        implements ClientBehaviorHolder, AjaxProps, BypassProps, CoreProps, DisabledProps, EventsKeyProps, EventsMouseProps, I18nProps {
    ...
    public UIMenuItem() {
        super();
        setRendererType("org.richfaces.MenuItemRenderer");
    }
    ...
    public String getIcon() {
        String value = (String) getStateHelper().eval(Properties.icon);
        return value;
    }
    ...
    public String getIconDisabled() {
        String value = (String) getStateHelper().eval(Properties.iconDisabled);
        return value;
    }

    public void setIconDisabled(String iconDisabled) {
        getStateHelper().put(Properties.iconDisabled, iconDisabled);
    }


    public Object getLabel() {
        Object value = (Object) getStateHelper().eval(Properties.label);
        return value;
    }
