...
public class HtmlMessageRenderer extends MessageRendererBase {
    ...
    private static final Attributes PASS_THROUGH_ATTRIBUTES5 = attributes()
            .generic("dir", "dir")
    ...
    public void doEncodeEnd(ResponseWriter responseWriter, FacesContext facesContext, UIComponent component)
        ...
        {
            String value = "rf-msg " + convertToString(component.getAttributes().get("styleClass"));
            if (null != value &&
                    value.length() > 0
            ) {
