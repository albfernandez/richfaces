...
public class UIMenuGroup extends AbstractMenuGroup
        implements ClientBehaviorHolder, CoreProps, DisabledProps, EventsKeyProps, EventsMouseProps, EventsPopupsProps, I18nProps, PositionProps {
