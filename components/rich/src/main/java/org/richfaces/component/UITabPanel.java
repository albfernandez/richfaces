...
public class UITabPanel extends AbstractTabPanel
    ...
    public HeaderAlignment getHeaderAlignment() {
        HeaderAlignment value = (HeaderAlignment) getStateHelper().eval(Properties.headerAlignment);
        return value;
    }

    public void setHeaderAlignment(HeaderAlignment headerAlignment) {
        getStateHelper().put(Properties.headerAlignment, headerAlignment);
    }


    public HeaderPosition getHeaderPosition() {
        HeaderPosition value = (HeaderPosition) getStateHelper().eval(Properties.headerPosition);
        return value;
    }

    public void setHeaderPosition(HeaderPosition headerPosition) {
        getStateHelper().put(Properties.headerPosition, headerPosition);
    }
    ...
    public String getTabActiveHeaderClass() {
        String value = (String) getStateHelper().eval(Properties.tabActiveHeaderClass);
        return value;
    }

    public void setTabActiveHeaderClass(String tabActiveHeaderClass) {
        getStateHelper().put(Properties.tabActiveHeaderClass, tabActiveHeaderClass);
    }


    public String getTabContentClass() {
        String value = (String) getStateHelper().eval(Properties.tabContentClass);
        return value;
    }

    public void setTabContentClass(String tabContentClass) {
        getStateHelper().put(Properties.tabContentClass, tabContentClass);
    }


    public String getTabDisabledHeaderClass() {
        String value = (String) getStateHelper().eval(Properties.tabDisabledHeaderClass);
        return value;
    }

    public void setTabDisabledHeaderClass(String tabDisabledHeaderClass) {
        getStateHelper().put(Properties.tabDisabledHeaderClass, tabDisabledHeaderClass);
    }


    public String getTabHeaderClass() {
        String value = (String) getStateHelper().eval(Properties.tabHeaderClass);
        return value;
    }

    public void setTabHeaderClass(String tabHeaderClass) {
        getStateHelper().put(Properties.tabHeaderClass, tabHeaderClass);
    }


    public String getTabInactiveHeaderClass() {
        String value = (String) getStateHelper().eval(Properties.tabInactiveHeaderClass);
        return value;
    }

    public void setTabInactiveHeaderClass(String tabInactiveHeaderClass) {
        getStateHelper().put(Properties.tabInactiveHeaderClass, tabInactiveHeaderClass);
    }
