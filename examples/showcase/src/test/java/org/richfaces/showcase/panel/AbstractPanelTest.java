...
public class AbstractPanelTest extends AbstractWebDriverTest {
     ...
     *
     * @param whichPart       the string representation of the JQLocator for panel's body
     * @param expectedContent the content which should be in the particular part of output panel
     */
