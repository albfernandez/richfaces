...
public class UIPoint extends AbstractChartPoint
    ...
    public Object getX() {
        Object value = (Object) getStateHelper().eval(Properties.x);
        return value;
    }
    ...
    public Object getY() {
        Object value = (Object) getStateHelper().eval(Properties.y);
        return value;
    }
