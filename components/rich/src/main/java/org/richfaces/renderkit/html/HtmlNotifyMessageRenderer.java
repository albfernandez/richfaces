...
public class HtmlNotifyMessageRenderer extends NotifyMessageRendererBase {
    ...
    private static final Attributes ATTRIBUTES_FOR_SCRIPT_HASH13 = attributes()
    ...
    private static final Attributes ATTRIBUTES_FOR_SCRIPT_HASH14 = attributes()
            .generic("onclick", "onclick", "click")
    ...
    public void doEncodeEnd(ResponseWriter responseWriter, FacesContext facesContext, UIComponent component)
        ...
        addToScriptHash(options, facesContext, component, ATTRIBUTES_FOR_SCRIPT_HASH13, null);


        addToScriptHash(options, facesContext, component, ATTRIBUTES_FOR_SCRIPT_HASH14, ScriptHashVariableWrapper.eventHandler);
