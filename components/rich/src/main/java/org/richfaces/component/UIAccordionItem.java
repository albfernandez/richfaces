...
public class UIAccordionItem extends AbstractAccordionItem
        implements ClientBehaviorHolder, AbstractTogglePanelTitledItem, CoreProps, EventsMouseProps, I18nProps {
