 ...
 * @version $Revision$
 */
public class ITestStackingMessages extends AbstractWebDriverTest {
    ...
    public void testRenderFirst() {
        ...
        page.topLeft();
        assertEquals(NotifyMessagePosition.TOP_LEFT, page.getNotify().getItem(0).advanced().getPosition());
    }
    ...
    public void testRenderSecond() {
        page.waitUntilThereIsNoNotify();
        page.bottomRight();
        assertEquals(NotifyMessagePosition.BOTTOM_RIGHT, page.getNotify().getItem(0).advanced().getPosition());
    }
